...
import network.SigmoidalNeuron;

import static rastrigin.Constants.NUM_TESTS;
...
public class NeuralLayer {
     ...
     */
    protected SigmoidalNeuron[] neurons;
     ...
     */
    public SigmoidalNeuron[] getNeurons(){
        return neurons;
    }
     ...
     */
    protected SigmoidalNeuron getNeuron(int i){
        return neurons[i];
    }
     ...
     */
    protected void setNeuron(int i, SigmoidalNeuron neuron){
    ...
    protected void init(){
        if(number_neurons >= 0){
            neurons = new SigmoidalNeuron[this.number_neurons];
            for(int i = 0; i < this.number_neurons; i++){
                neurons[i] = new SigmoidalNeuron(this.controller, number_inputs, this.layer_id, i);
            }
        }
    }
    ...
    /**
     * Updating Weights for Hidden Layer Besides the Last One
     */
    public void updateDeltas(double[] delta, double[][] weights){}
}
